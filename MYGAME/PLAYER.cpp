...
void PLAYER::draw()
{
	...
	graphics::drawSector(thesix -15, thesiy + 5, 15, 32, 0, 90, br2);
	graphics::setOrientation(0.f);

	// paikths eikona
	br.outline_opacity = 0.0f;
	br.texture = std::string(ASSET_PATH) + "PAIKTHS_ARISTERA.png";
...
ORIO PLAYER::getSugkroush() const
{
	ORIO orio;
	orio.cx = thesix;
	orio.cy = thesiy;
